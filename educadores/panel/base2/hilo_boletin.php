...
//	$mail->Host       = "olvacourier.info"; // sets the SMTP server
	$mail->Username = "boletin@olvacourier.info";
	$mail->Password = "compraonlinecourier2011";
	$mail->From = "boletin@olvacourier.info";
	}
...
function sendTo($email,$cuenta,$pass,$asunto,$html,$fromName,$replayTo,$IdProveedor){
	...
	$cuenta='boletin01@olvacourier.info';
	$cuenta='boletin01@olvacourier.info';
//prin("$email,$cuenta,$pass,$asunto,$html,$fromName,$replayTo,$IdProveedor");
	...
	try {
	  ...
	  case "6":
			...
			$mail->Port = 25;	
			$cuenta='boletin@olvacourier.info';
