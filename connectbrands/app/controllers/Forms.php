			...
			[
				...
				'post'			=> [
					...
					'html'	=>'
						...
						<h3>TORATTO GRUPO INMOBILIARIO</h3>
<p>Calle Garcilaso de la Vega 2191 Lince<br>
Teléfono: +511 3732050<br><br>
</p>
						<h2>Contáctenos</h2>
						<p>Si desea información acerca de Toratto Grupo Inmobiliario por favor ingrese sus datos en el siguiente formato y nos pondremos en contacto con usted:</p>'
					]
	...
	function vende_tu_terreno(){
		...
		$this->view->render(
			...
			[
				...
				'banner'			=> 'grupo-inmobiliario-toratto.jpg',
