		...
		*/
		...
		$this->view->assign(
			[
				...
				'head_description'=> limit_string(($this->view->vars['web_desc'])?$this->view->vars['web_desc']:'',150),

				//head
				// 'head_title'    => $this->title. ( ($this->slogan)?' - '.$this->slogan:'' ),
				'head_title'    => $this->title." :: Transformadores, Estabilizadores, Luces de emergencia, UPS en Lima Perú",

				'head_keywords' => 'Best,Power,Peru,Transformadores,Estabilizadores,Luces,emergencia,UPS,Lima,Perú',
