...
/******/ 	return __webpack_require__(__webpack_require__.s = "../limpofer/app/sources/es6/app.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "../limpofer/app/sources/components/block_banner/block_banner.js":
/*!***********************************************************************!*\
  !*** ../limpofer/app/sources/components/block_banner/block_banner.js ***!
  \***********************************************************************/
/*! no static exports found */
...
eval("module.exports = () => {\n  if (is_local) console.log('agro / form_contact');\n\n  if ($('#map').length > 0) {\n    let map;\n    let dmap = $(\"#map\");\n    map = new GMaps({\n      div: '#map',\n      lat: dmap.data(\"lat\"),\n      lng: dmap.data(\"lon\")\n    });\n    map.addMarker({\n      lat: dmap.data(\"lat\"),\n      lng: dmap.data(\"lon\"),\n      title: dmap.data(\"name\"),\n      infoWindow: {\n        content: dmap.data(\"text\")\n      }\n    });\n  }\n};\n\n//# sourceURL=webpack:///../limpofer/app/sources/components/form_contact/form_contact.js?");

/***/ }),

/***/ "../limpofer/app/sources/components/gallery_products/gallery_products.js":
/*!*******************************************************************************!*\
  !*** ../limpofer/app/sources/components/gallery_products/gallery_products.js ***!
  \*******************************************************************************/
/*! no static exports found */
...
eval("module.exports = () => {\n  if (is_local) console.log('consorcio / gallery_products'); // if($('.class').length>0){\n  // requirejs(['vendor.min'],()=>{\n  // loadCss('vendor.css');\n  // });\n  // }\n};\n\n//# sourceURL=webpack:///../limpofer/app/sources/components/gallery_products/gallery_products.js?");

/***/ }),

/***/ "../limpofer/app/sources/components/header/header.js":
/*!***********************************************************!*\
  !*** ../limpofer/app/sources/components/header/header.js ***!
  \***********************************************************/
/*! no static exports found */
...
eval("module.exports = () => {\n  if (is_local) console.log('asiste / home_block_descuentos');\n  let domm = '.home_block_descuentos';\n\n  if ($(domm + ' .responsive').length > 0) {\n    requirejs(['slick.min'], () => {\n      loadCss('slick.css');\n      $(domm + ' .responsive').slick({\n        dots: true,\n        infinite: true,\n        speed: 300,\n        slidesToShow: 4,\n        slidesToScroll: 4,\n        autoplay: true,\n        autoplaySpeed: 8000,\n        // fade: true,\n        // cssEase: 'linear',\n        responsive: [{\n          breakpoint: 992,\n          settings: {\n            slidesToShow: 2,\n            slidesToScroll: 2,\n            infinite: true,\n            dots: true\n          }\n        }, {\n          breakpoint: 600,\n          settings: {\n            slidesToShow: 1,\n            slidesToScroll: 1\n          }\n        } // You can unslick at a given breakpoint now by adding:\n        // settings: \"unslick\"\n        // instead of a settings object\n        ]\n      }); // $('.venobox').venobox(); \n      // console.log('slick');\n    });\n  }\n};\n\n//# sourceURL=webpack:///../limpofer/app/sources/components/home_block_descuentos/home_block_descuentos.js?");

/***/ }),

/***/ "../limpofer/app/sources/components/home_block_importaciones/home_block_importaciones.js":
/*!***********************************************************************************************!*\
  !*** ../limpofer/app/sources/components/home_block_importaciones/home_block_importaciones.js ***!
  \***********************************************************************************************/
/*! no static exports found */
...
eval("module.exports = () => {\n  if (is_local) console.log('ardyss / home_block_importaciones');\n  let domm = '.home_block_importaciones';\n\n  if ($(domm + ' .responsive').length > 0) {\n    requirejs(['slick.min'], () => {\n      loadCss('slick.css');\n      $(domm + ' .responsive').slick({\n        dots: true,\n        infinite: true,\n        speed: 300,\n        slidesToShow: 3,\n        slidesToScroll: 3,\n        autoplay: true,\n        autoplaySpeed: 8000,\n        // fade: true,\n        // cssEase: 'linear',\n        responsive: [{\n          breakpoint: 992,\n          settings: {\n            slidesToShow: 2,\n            slidesToScroll: 2,\n            infinite: true,\n            dots: true\n          }\n        }, {\n          breakpoint: 600,\n          settings: {\n            slidesToShow: 1,\n            slidesToScroll: 1\n          }\n        } // You can unslick at a given breakpoint now by adding:\n        // settings: \"unslick\"\n        // instead of a settings object\n        ]\n      }); // $('.venobox').venobox(); \n      // console.log('slick');\n    });\n  }\n};\n\n//# sourceURL=webpack:///../limpofer/app/sources/components/home_block_importaciones/home_block_importaciones.js?");

/***/ }),

/***/ "../limpofer/app/sources/components/home_block_notes/home_block_notes.js":
/*!*******************************************************************************!*\
  !*** ../limpofer/app/sources/components/home_block_notes/home_block_notes.js ***!
  \*******************************************************************************/
/*! no static exports found */
...
eval("module.exports = () => {\n  if (is_local) console.log('home_block_notes'); // if($('.class').length>0){\n  // requirejs(['vendor.min'],()=>{\n  // loadCss('vendor.css');\n  // });\n  // }\n};\n\n//# sourceURL=webpack:///../limpofer/app/sources/components/home_block_notes/home_block_notes.js?");

/***/ }),

/***/ "../limpofer/app/sources/es6/app.js":
/*!******************************************!*\
  !*** ../limpofer/app/sources/es6/app.js ***!
  \******************************************/
/*! no static exports found */
...
eval("($ => {\n  $(() => {\n    __webpack_require__(/*! ./fix */ \"../limpofer/app/sources/es6/fix.js\")(); // require(\"./materialize/scrollspy\")();\n    // materialize slider\n    // require(\"./materialize/sidenav\")();\n    // materialize slider\n    // require(\"./materialize/slider\")();\n    // require(\"./materialize/modal\")();\n    // plugin for google maps\n    // require(\"./map\")();\n    // menu fixed\n    // require(\"./headfixed\")();\n    // parallax\n    // require(\"./materialize/parallax\")();\n    // require(\"./lightbox\")();\n    // lightbox for video\n    // require(\"./venobox\")();\n    // lightbox for photos\n\n\n    __webpack_require__(/*! ./magnific-popup */ \"../limpofer/app/sources/es6/magnific-popup.js\")(); // remove href when href=#\n\n\n    $(\"a[href=#]\").removeAttr('href'); //selectdate \n\n    $(\"#select_date\").on(\"change\", e => {\n      var vall = $(e.target).val();\n      $(\".dates_all\").hide();\n      $(\".dates_\" + vall).show();\n    }); // Begin Components\n\n    __webpack_require__(/*! ../../../../work/app/sources/components/common/common.js */ \"../work/app/sources/components/common/common.js\")();\n\n    __webpack_require__(/*! ../../../../work/app/sources/components/menu_left/menu_left.js */ \"../work/app/sources/components/menu_left/menu_left.js\")();\n\n    __webpack_require__(/*! ../../../../work/app/sources/components/block_gallery/block_gallery.js */ \"../work/app/sources/components/block_gallery/block_gallery.js\")();\n\n    __webpack_require__(/*! ../../../../limpofer/app/sources/components/block_banner/block_banner.js */ \"../limpofer/app/sources/components/block_banner/block_banner.js\")();\n\n    __webpack_require__(/*! ../../../../limpofer/app/sources/components/block_banner2/block_banner2.js */ \"../limpofer/app/sources/components/block_banner2/block_banner2.js\")();\n\n    __webpack_require__(/*! ../../../../limpofer/app/sources/components/header/header.js */ \"../limpofer/app/sources/components/header/header.js\")();\n\n    __webpack_require__(/*! ../../../../limpofer/app/sources/components/home_block_importaciones/home_block_importaciones.js */ \"../limpofer/app/sources/components/home_block_importaciones/home_block_importaciones.js\")();\n\n    __webpack_require__(/*! ../../../../limpofer/app/sources/components/home_block_descuentos/home_block_descuentos.js */ \"../limpofer/app/sources/components/home_block_descuentos/home_block_descuentos.js\")();\n\n    __webpack_require__(/*! ../../../../limpofer/app/sources/components/gallery_products/gallery_products.js */ \"../limpofer/app/sources/components/gallery_products/gallery_products.js\")();\n\n    __webpack_require__(/*! ../../../../onelimites/app/sources/components/product_detail/product_detail.js */ \"../onelimites/app/sources/components/product_detail/product_detail.js\")();\n\n    __webpack_require__(/*! ../../../../limpofer/app/sources/components/form_contact/form_contact.js */ \"../limpofer/app/sources/components/form_contact/form_contact.js\")();\n\n    __webpack_require__(/*! ../../../../onelimites/app/sources/components/products_reel/products_reel.js */ \"../onelimites/app/sources/components/products_reel/products_reel.js\")();\n\n    __webpack_require__(/*! ../../../../limpofer/app/sources/components/home_block_notes/home_block_notes.js */ \"../limpofer/app/sources/components/home_block_notes/home_block_notes.js\")();\n\n    __webpack_require__(/*! ../../../../asiste/app/sources/components/home_block_links/home_block_links.js */ \"../asiste/app/sources/components/home_block_links/home_block_links.js\")(); // Finish Components\n\n  });\n})(jQuery);\n\n//# sourceURL=webpack:///../limpofer/app/sources/es6/app.js?");

/***/ }),

/***/ "../limpofer/app/sources/es6/fix.js":
/*!******************************************!*\
  !*** ../limpofer/app/sources/es6/fix.js ***!
  \******************************************/
/*! no static exports found */
...
eval("module.exports = () => {\n  // Detect touch screen and enable scrollbar if necessary\n  let is_touch_device = () => {\n    try {\n      document.createEvent(\"TouchEvent\");\n      return true;\n    } catch (e) {\n      return false;\n    }\n  };\n\n  if (is_touch_device()) {\n    $('#nav-mobile').css({\n      overflow: 'auto'\n    });\n  }\n  /*\n  var windowsize = $(window).width();\n   $(window).resize(function() {\n    var windowsize = $(window).width();\n  });\n   if (windowsize > 600) {\n     console.log('mayor de 600');\n   }\n  */\n\n};\n\n//# sourceURL=webpack:///../limpofer/app/sources/es6/fix.js?");

/***/ }),

/***/ "../limpofer/app/sources/es6/magnific-popup.js":
/*!*****************************************************!*\
  !*** ../limpofer/app/sources/es6/magnific-popup.js ***!
  \*****************************************************/
/*! no static exports found */
