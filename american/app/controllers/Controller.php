...
class Controller extends \core\Controller {
	...
	function __construct($params){
		...
		$replace_menu_left['inmuebles']='Inmuebles';
		...
		$replace_menu_top['inmuebles']='Inmuebles';
		...
		//menu bottom
		$this->menu_bottom=$this->menu_top;
		unset($this->menu_bottom[0]);
		foreach($this->menu_bottom as $ii=>$itemm){
			if(sizeof($itemm['items'])>0){
				$this->menu_bottom[$ii]['url']=$itemm['items'][0]['url'];
				unset($this->menu_bottom[$ii]['items']);
			}
		}
		// prin($this->menu_bottom);
		...
		$this->view->assign(
			[
				...
				'logo'             => 'logo_american_header.png',
				// 'header_bg'     => $header_bg['img'],
				// 'header_phones' => $web['header_phones'],
				'icon'             => 'logo_american_header.png?'.$this->static_build,
