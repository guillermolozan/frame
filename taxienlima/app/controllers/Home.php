...
class Home extends Controller {
	...
	function index($params){
		...
		$Page=$this->loadModel('Pages',['items'=>['filter'=>'limit 0,50']]);

		// servicios
		$servicios=[
		'name'=>'Tarifas',
		'items'=>$Page->getMenu(['item'=>'4','uri'=>'pagina','more_fields'=>'text'])
		];
		...
		$Links->setConfig([
					'items'=>['fields'=>'name,url,fecha_creacion,file','target'=>'_blank'],
				]);
