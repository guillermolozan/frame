...
class Controller extends \core\Controller {
	...
	function __construct($params){
		...
		$replace_menu_left['pagina/empresa/4']='Empresa';
		...
		// 	$servicios_items[$ii]['url']=strtolower($servicio['url']).'/'.
		...
		// $replace_menu_left['galeria-fotos-promociones/1']='Promociones';
		$replace_menu_left['red-de-talleres']='Red de talleres';
		...
		$replace_menu_top['pagina/empresa/4']='Empresa';
		...
		$replace_menu_top['red-de-talleres']='Red de talleres';

		// $replace_menu_top['haga-su-res
		// erva']='Haga su Reserva';
		// $replace_menu_top['galeria-fotos-promociones/1']='Promociones';
		...
		$this->menu_prefooter=$this->menu_top;
		$this->menu_prefooter[]=[
			'name'=>'',
			'class'=>'facebook',
			'url'=>'Facebook'
		...
		$this->menu_footer['0']['name']='Site Created by prodiserv';


		// prin($this->static_build);

		$static_build=$this->static_build;
		...
		$this->view->assign(
			[
				...
				'logo'             => 'logo-daihatsu-header.jpg',
				// 'header_bg'     => $header_bg['img'],
				// 'header_phones' => $web['header_phones'],
				'icon'             => 'icono-daihatsu2.png'.'?'.$static_build,
				//prefooter
