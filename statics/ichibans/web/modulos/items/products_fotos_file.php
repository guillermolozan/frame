...
$_GET['id']=($_GET['id']!='')?$_GET['id']:select_dato("id","products_fotos","where 1 order by id desc limit 0,1",0);
...
$object=array_merge($object, paginacion(
			...
			,"products_fotos_fotos"
			,"where 1 and $FILTRO $ORDEN"
			,0
			,array(
				'fecha'=>array('fecha'=>array('{fecha}','5')),			
				'foto:atributos'=>array('atributos'=>'prodfot_imas,{fecha_creacion},{file},1,150x110,1'),
				'foto:url'=>array('archivo'=>'prodfot_imas,{fecha_creacion},{file},4'),
...
$object['panel']=array('products_FOTOS','products_FOTOS_FOTOS');
//////////////////////CONECTOR/////////////
