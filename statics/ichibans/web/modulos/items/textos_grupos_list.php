...
$LISTA = paginacionnumerada(
			...
			,0
			,array(
				'url'=>array('url'=>array('url'=>"index.php?modulo=items&tab=textos_items&acc=list&fil=cursos&val={id}&friendly={nombre}")),		
				'texto'=>array('limit'=>array('{texto}','200')),
				'foto:atributos'=>array('atributos'=>'texgru_imas,{fecha_creacion},{file},2,140x120,1'),
				'esquema'=>'foto,nombre:h2,texto',
			)
        );
/*
$LISTA['combo']=array(
