...
// $object['menu']=web_procesar_menu($object['menu']);
	...
	$object['header']=array(
						...
						'url'=>procesar_url('index.php?'.$filtro_param.'modulo=items&tab=products_fotos&acc=list'),
	...
	$object['items']= select(
		...
		array(
			...
			'url'=>array('url'=>array("index.php?".$filtro_param."modulo=items&tab=products_fotos&acc=file&id={id}&friendly={nombre}")),

			'foto'=>array('foto'=>array("id,file,foto_descripcion,fecha_creacion|products_fotos_fotos|where id_grupo='{id}' and visibilidad='1' order by id asc limit 0,1",
