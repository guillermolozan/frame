...
?><ul class="formulario"><?php
    ...
    ?><li class="linea_form" id="linea_crear"><?php
            ...
            ?><input type="button" id="in_submit" class="form_boton_1" value="<?php echo ($Paction)?$Paction:'Crear '.$datos_tabla['nombre_singular']?>" style="float:left;" onclick="ax('insertar','');"  /><?php
    ...
    ?><li class="linea_form" id="linea_grabar" style="display:none;"><?php
            ...
            ?><input type="button" id="ed_save" class="form_boton_1" value="<?php echo ($Paction)?$Paction:'Guardar '.$datos_tabla['nombre_singular']?>" style="float:left;" <?php
...
echo '<script>';
if($_GET['L']!=''){ echo "pre_crear();window.addEvent('domready',function(){ ax('ec3','".$_GET['L']."'); });$0('linea_crear');$1('linea_grabar');$0('ed_cancelar');"; }
echo '</script>';
