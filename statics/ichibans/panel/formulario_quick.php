...
?><ul class="formulario"><?php
    ...
    ?><li class="linea_form" id="linea_crear"><?php
            ...
            ?><input type="button" id="in_submit" class="form_boton_1" value="<?php echo ($Pbuttom)?$Pbuttom:'Crear '.$datos_tabla['nombre_singular']?>" style="float:left;" onclick="ax('insertar','');"  /><?php
    ...
    ?><li class="linea_form" id="linea_grabar" style="display:none;"><?php
            ...
            ?><input type="button" id="ed_save" class="form_boton_1" value="<?php echo ($Pbuttom)?$Pbuttom:'Guardar '.$datos_tabla['nombre_singular']?>" style="float:left;" <?php
...
echo "pre_crear();";
echo "window.addEvent('domready',function(){ ax('ec3','".$_GET['L']."'); });";
