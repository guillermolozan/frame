<style>
.anio { position:relative; margin-bottom:4px; }
.anio .mes { position:absolute; top:0px; width:65px; text-align:center; background-color:#ccc; }
.anio .selected { background-color:#FF3300; color:#FFFFFF; }
</style>
<div class='anio' style="clear:left;">
<b><a href="tools.php?tab=estadisticas" style="width:100px;" class="mes <?php echo ($_GET['anio']=='' and $_GET['file']=='')?"selected":"" ?>" >Estadísticas</a></b>:
</div>
...
?>
<style>
.img_chart { position:absolute; top:40px; right:10px; } 
</style>
<div class='cuadro_codigo bloque' style='position:relative; height:auto !important; height:800px; min-height:800px;' >
<?php //<pre> ?>
<?php
