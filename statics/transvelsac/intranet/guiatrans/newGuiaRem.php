...
<body>
    <div id="container">
      ...
      <div id="mainContent">
      <p class="titulo">Nueva Guia de Transportista</p>
...
<?php
	...
	$qry=mysql_query("select numero as idGuia from tipodocumento WHERE idtipodoc='GT' ");
...
?>  
      ...
      <tr>
          ...
          <td width="20%" colspan="2"><input type="text" id="nombretransportista" name="nombretransportista" size="35"/>&nbsp;<a href="javascript:void(0)" onClick="hija=window.open('../tablas/searchChoferes.php', 'Sizewindow', 'width=850, height=600, scrollbars=no, toolbar=no'); return false;"><img src="../images/icono_buscar.gif" border="0" alt="Buscar Vehiculo" /></a></td>
