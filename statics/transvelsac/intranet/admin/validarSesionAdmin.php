...
function CheckNivel() {
$valor=0;
   if(!empty($_SESSION['idUsuario']) && !empty($_SESSION['nomUsuario']) && !empty($_SESSION['idRol']) && !empty($_SESSION['idSucursal']) && $_SESSION['idRol']=='4') 
   {
		...
		$_SESSION['idUsuario'] = mysql_real_escape_string($_SESSION['idUsuario']);
      	//$_SESSION['token'] = mysql_real_escape_string($_SESSION['token']);
	   	//$_SESSION['codUsuario'] = mysql_real_escape_string($_SESSION['codUsuario']);
