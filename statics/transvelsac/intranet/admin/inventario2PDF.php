...
require_once("../pdf/dompdf-0.5.1/dompdf_config.inc.php");
	...
	$html .='<p align="left">INVENTARIO EN TRASLADO ('.$fecha.')</p>';
...
$dompdf->render();
$archivo="Inv_Tras_".$nomEmpresa."_".$fecha2.".pdf";
