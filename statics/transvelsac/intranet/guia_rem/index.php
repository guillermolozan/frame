...
<body>
    <div id="container">
      ...
      <div id="mainContent">
      <p class="titulo">Buscar <a href="index.php" style=" color:#FFFFFF">Guias de Remisión</a></p>
      <?php 
					if(isset($_GET['msg'])){ 
					$display="";
						if($_GET['msg']=='1')
    ...
    <label>Numero de Guia</label>&nbsp;<input type="text" name="numGuia" id="numGuia" size="12" />
    &nbsp;&nbsp;
...
&nbsp;&nbsp;<input type="reset" id="buscarAvanzado" name="buscarAvanzado" value="Limpiar" style="border:#CCCCCC 1px solid; background:#666666; color:#ffffff" />
  ...
  <table width="98%" align="center" style="margin:0 10px;">
    ...
    <td align="right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="button" name="newVenta" value="Nueva Guia Remision" onClick="javascript:cargarDocum()" style=" float:right;border:#CCCCCC 1px solid; background:#666666; color:#ffffff" /></td><tr>
  </table>

   <p class="titulo">Resultado de la Busqueda</p>
  <?php 
	$consultaBase = "SELECT guiacab.*, motivo.nombre as motivo FROM guiacab LEFT JOIN motivo ON motivo.idmotivo=guiacab.idmotivo WHERE guiacab.estado=1 AND guiacab.idsucursal='$idSucursal' ";
...
?>
      ...
      <tr>
            ...
            <td width="30%" align="center" class="title"><div align="center">Motivo</div></td>
	...
	?>              
      <tr>
            ...
            <td class="tdcont">&nbsp;&nbsp;<?php echo $rs['motivo']; ?></td>
            <td>
...
<a href="javascript:void(0)" onClick="hija=window.open('verSalidaPDF.php?idGuia=<?php echo $rs['idguiacab']; ?>', 'Sizewindow', 'width=1020, height=700, scrollbars=yes, toolbar=no'); return false;"><img src="../imagen/pdf.png" alt="Ver" border="0" /></a>&nbsp;            
            <a href="delGuiaRem.php?idGuia=<?php echo $rs['idGuia']; ?>"><img src="../imagen/icon_del.png" alt="Cancelar" border="0" /></a>
