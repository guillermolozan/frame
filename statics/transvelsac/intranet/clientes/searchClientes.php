...
window.opener.document.getElementById('idcliente').value ='<?php echo $rs['idcliente']; ?>';
...
window.opener.document.getElementById('direccion').value ='<?php echo $rs['direccion']; ?>';
window.close();
">Agregar</a></td>
        </tr>
    <?php		
