...
extract($_REQUEST);
	...
	$resultado = mysql_query($adc);
	  ...
	  $sql="insert into caja (tipomovimiento,tiporegistro,tipodoc, serie, numero, idcliprov, iddocumentoorigen, tipodocdo, seriedo, numerodo, fecha, monto, tipopagocobro, fechareg, usuarioreg) values ('1', '1', '$IdTipoDoc', '$Serie', '$Numero', '$IdCliente', '$IdVentasCab', '$IdTipoDoc', '$Serie', '$Numero', '$Fecha', '$Monto', '1', '$FechaActual', '$idUsuario')";
	  $resultado = mysql_query($sql);	
