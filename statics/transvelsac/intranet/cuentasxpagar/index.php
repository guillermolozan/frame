...
&nbsp;&nbsp;<input type="reset" id="buscarAvanzado" name="buscarAvanzado" value="Limpiar" style="border:#CCCCCC 1px solid; background:#666666; color:#ffffff" />
  ...
  <table width="98%" align="center" style="margin:0 10px;">
    <tr>
    <?php 
	  $consultaBase = "SELECT cc.*, vc.proveedor, (SELECT SUM(monto) FROM amortizar WHERE amortizar.idcuotas=cc.idcuotascompra) AS amortizado  FROM cuotascompra as cc LEFT JOIN comprascab as vc ON vc.idcomprascab=cc.idcomprascab ";
    ...
    if($buscarVenta=='1' or $BCaja=='1')	
    {
	  ...
	  if(isset($idCliente) and $idCliente != '0')
	  {
		...
		$filtro = " " . "vc.idproveedor='$idCliente'";
	...
	$up="DESC";
	$orden="cc.idcuotascompra";//ordena por id	
  ...
  ?>
      ...
      <td><div align="center" class="tdcont"><a href="amortizarDeuda.php?idCuotas=<?php echo $rs['idcuotascompra']; ?>"><img src="../imagen/icon_ver.png" alt="Ver" border="0" /></a>&nbsp;<a href="delCuentaXCobrar.php?idCuotas=<?php echo $rs['idcuotascompra']; ?>"><img src="../imagen/icon_del.png" alt="Eliminar" border="0" /></a></div></td>
      </tr>
   <?php		
	}
	mysql_free_result($q);
