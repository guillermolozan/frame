...
<body>
  ...
  <FORM ACTION="saveNewBoletaNormal.php"  class="cmxform" id="frmNewBoletaNormal" NAME="frmNewBoletaNormal" METHOD="POST">      
   ...
   <tr>
   	...
   	<td class="tdcont" width="33%">&nbsp;&nbsp;&nbsp;
     <input type="radio" name="calculoM" id="calculoM1" value="M" onclick="javascript:fcalculoMargen(1)" checked="checked">Por Total Boleta
