...
<form method="post" action="saveNewBoletaNormal.php?nroCuotas=<?php echo $nroCuotas; ?>&idVendedor=<?php echo $idVendedorC; ?>&calculoMargen=<?php echo $calculoMargen; ?>&calculoIGV=<?php echo $calculoIGV; ?>" class="cmxform" name="frmAddCuotas" id="frmAddCuotas" enctype="multipart/form-data" style="font-size:10px; margin-top:10px; text-align:center">
