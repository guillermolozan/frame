...
function editarDocum($idComprobante,$tipoComprobante)
{
  if ($tipoComprobante=="1") {
    window.open('editarFactura.php?idVentasCab=' + $idComprobante, '_self');
  }
  if ($tipoComprobante=="2") {
    window.open('verBoleta.php?idVentasCab=' + $idComprobante, '_self');
  }
  if ($tipoComprobante=="3") {
    window.open('verRecibo.php?idVentasCab=' + $idComprobante, '_self');
  }
}
function verDocum($idComprobante,$tipoComprobante)
{
  if ($tipoComprobante=="1") {
    window.open('verFactura.php?idVentasCab=' + $idComprobante, 'Sizewindow', 'width=820, height=550, scrollbars=yes, toolbar=no');
  }
  if ($tipoComprobante=="2") {
    window.open('verBoleta.php?idVentasCab=' + $idComprobante, 'Sizewindow', 'width=820, height=550, scrollbars=yes, toolbar=no');
  }
  if ($tipoComprobante=="3") {
    window.open('verRecibo.php?idVentasCab=' + $idComprobante, 'Sizewindow', 'width=820, height=550, scrollbars=yes, toolbar=no');
  }
}
...
&nbsp;&nbsp;<input type="reset" id="buscarAvanzado" name="buscarAvanzado" value="Limpiar" style="border:#CCCCCC 1px solid; background:#666666; color:#ffffff" />
  ...
  <table width="98%" align="center" style="margin:0 10px;">
    ...
    <td align="right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="button" name="newVenta" value="Nueva Venta" onClick="javascript:cargarDocum()" style=" float:right;border:#CCCCCC 1px solid; background:#666666; color:#ffffff" /></td><tr>
  </table>
  <br />
  ...
  <table width="98%" align="center" style="margin:0 10px;">
    <tr>
    <?php 
	  $consultaBase = "SELECT vc.* FROM ventascab as vc LEFT JOIN cliente as cl ON vc.idcliente=cl.idcliente WHERE vc.idsucursal='$idSucursal' ";
  ...
  ?>
      ...
      <td><div align="center" class="tdcont"><a href="#" onClick="javascript:editarDocum('<?php echo $rs['idventascab']; ?>','<?php if($rs['idtipodoc'] == "FA") echo '1'; else { echo '2'; }; ?>')"><img src="../imagen/icon_edit.png" alt="Ver" border="0" /></a>&nbsp;<a href="#" onClick="javascript:verDocum('<?php echo $rs['idventascab']; ?>','<?php if($rs['idtipodoc'] == "FA") echo '1'; else { echo '2'; }; ?>')"><img src="../imagen/icon_ver.png" alt="Ver" border="0" /></a>&nbsp;<a href="delDocumento.php?idVentasCab=<?php echo $rs['idventascab']; ?>"><img src="../imagen/icon_del.png" alt="Eliminar" border="0" /></a></div></td>
      </tr>
   <?php		
	}
	mysql_free_result($q);
