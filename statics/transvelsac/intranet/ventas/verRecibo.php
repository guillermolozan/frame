      ...
      <br /><br />
	   <table width="98%" align="center" style="margin:0 10px;">
        ...
        <?php
		    ...
		    if ($tipoCalculoUtilidad=="0")
		    {
        ?>
        <tr>
            <td width="5%" align="center" class="title"><div align="center" >Nº</div></td>
            <td width="50%" align="center" class="title"><div align="center">Concepto</div></td>
            <td width="22%" align="center" class="title" colspan="2"><div align="center">Fecha Vencimiento</div></td>
            <td width="10%" align="center" class="title"><div align="center">Cantidad</div></td>
        ...
        <?php
		    ...
		    if ($tipoCalculoUtilidad=="0")
		    {
			  $idPagoCliente = $rs3['PAGO_CLIENTE_idPagoCliente'];
  	          $sqlPC = "SELECT * FROM pago_cliente WHERE idPagoCliente='$idPagoCliente'";
	          $consultaPC = consulta($sqlPC);
	          while($rsPC = leer_registro($consultaPC))
	          {
			    $fechaVencimiento = $rsPC['fechaVencimiento'];
	          }
        ?>
           <tr>
            <td height="20" class="tdcont" align="center"><?php echo $con ?></td>
            <td class="tdcont" align="center"><?php echo "Pago de Cuota por venta al credito" ?></td>
            <td class="tdcont" colspan="2" align="center">&nbsp;&nbsp;<?php echo substr($fechaVencimiento,0,10) ?></td>
            <td class="tdcont" align="center"><?php echo redondeado($rs3['cantidad']) ?></td>
