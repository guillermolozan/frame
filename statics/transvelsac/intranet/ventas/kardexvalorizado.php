...
function visualizarDocum($idProducto,$idEmpresa)
{
  window.open('verDetalleStock.php?idProducto=' + $idProducto + '&idEmpresa=' + $idEmpresa, 'Sizewindow', 'width=900, height=400, scrollbars=yes, toolbar=no');
}
</script>
...
// Si eligieron que el producto deberia pertenecer a una determinado tipo de producto y modelo
  ...
  if($buscarProd=='1') {
	...
	?>
    	<tr>
          ...
          <td align="right" class="tdcont"><?php echo redondeado($precioVenta); ?></td>
            <td><div align="center" class="tdcont"><a href="#" onClick="javascript:visualizarDocum('<?php echo $rs['idProducto']; ?>','<?php echo $idEmpresa; ?>')"><img src="../imagen/icon_ver.png" alt="Ver" border="0"  height="10"/></a></div></td>
        </tr>
    <?php		
	}
	mysql_free_result($q);
    ...
    <td width="5%" align="center" class="title"><div align="center" ><a href="javascript:void(0)" onclick="javascript:imprimirReporte()">Imprimir Saldos Valorizado</a></div></td>
