...
<style type="text/css">
	...
	$html .='<div>
			...
			<br><br>
			<div style="width:700px; height:auto; align="center">';
	...
	$html .='<p align="left">UBICACION DEL PRODUCTO A LA FECHA --> ('.$fecha.')</p>';
		...
		$sql2="SELECT su.nomSucursal,p.nomProd,sp.estadoSerie,count(sp.idSerie) as total FROM serie_producto as sp LEFT JOIN producto as p ON sp.MOVIMIENTO_PRODUCTO_PRODUCTO_idProducto = p.idProducto LEFT JOIN sucursal as su ON sp.idUbicacion=su.idSucursal WHERE (sp.estadoSerie='$estadoSerie' OR sp.estadoSerie='$estadoSerie2') AND p.idProducto='$idProducto' GROUP BY su.nomSucursal,p.nomProd,sp.estadoSerie ORDER BY su.nomSucursal";
