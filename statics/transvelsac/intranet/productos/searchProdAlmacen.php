...
<div id="busqueda" >
<form method="post" style="font-size:10px; margin-top:10px; text-align:center; display:V" action="searchProdAlmacen.php" name="frmBuscarProd" id="frmBuscarProd" enctype="multipart/form-data">
		<label>Codigo :</label>
...
// Si eligieron que el producto deberia pertenecer a una determinado tipo de producto y modelo
  ...
  if($buscarProd=='1' or $BProd=='1') {
	...
	if($total_registros) {
		...
		$principal="searchProdAlmacen";//pagina principal
		if(($pagina - 1) > 0) {
   ...
   else
  {
	...
	?>
  		...
  		<tr>
            ...
            <td align="center" class="title"><div align="center">P. Compra</div></td>
