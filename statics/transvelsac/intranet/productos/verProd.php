...
<?php
	...
	$idMarca=$rs['idmarca'];
	?>
    	<input type="hidden" id="idProd" name="idProd" value="<?php echo $rs['idProducto']; ?>" />
  <tr>
    <td class="title" width="10%"><strong >Nombre</strong></td>
    <td width="40%" class="tdcont"><input type="text" name="nombre" id="nombre" value="<?php echo $rs['nombre']; ?>" style="text-transform:uppercase" size="50" readonly="readonly"/><b class="alert">*</b></td>
    <td class="title" width="10%"><strong >Descripción Corta</strong></td>
    <td class="tdcont"><input type="text" name="nombrecorto" id="nombrecorto" value="<?php echo $rs['nombrecorto']; ?>" style="text-transform:uppercase" size="40" readonly="readonly"/><b class="alert">*</b></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="tdcont"><br />
      <input type="text" name="stockMinimo" id="stockMinimo"  value="<?php echo $rs['stockminimo']; ?>" maxlength="6" size="10" readonly="readonly"/><b class="alert">*</b></td>
 ...
 <div align="right"><input name="sbmReturn" type="button" id="sbmReturn" value="Cancelar" onClick="window.open('index.php', '_self');" class="boton"/></div>
</FORM>
     <!-- end #mainContent --></div>
      <div id="footer">
