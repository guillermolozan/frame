...
<body>
  ...
  <p class="titulo">REGISTRO DE TIPO DE DOCUMENTOS</p>
	    <?php 
				if(isset($_GET['msg']))
				{ 
					$display="";
      		...
      		<div id="busqueda">
   			...
   			<input type="button" id="nuevoTipoDocumento" name="nuevoTipoDocumento" value="Nuevo Tipo Documento" onClick="window.open('nuevoTipoDocumento.php', '_self');" style=" float:right;border:#CCCCCC 1px solid; background:#666666; color:#ffffff" />
   			<br /><br />

   			<?php 
        	$consultaBase="SELECT * FROM tipodocumento";
	...
	<table width="98%" align="center" style="margin:0 10px;">
       	<tr>
			...
			?>
  		 	...
  		 	<tr>
            	...
            	<td width="70%" align="center" class="title"><div align="center">Serie</div></td>
            	<td width="70%" align="center" class="title"><div align="center">Numero</div></td>
		...
		?>
     	  ...
     	  <tr>
           	...
           	<td class="tdcont" align="left"><?php echo $rs['numero']; ?></td>
            <td>
			<div align="center" class="tdcont">
			<a href="editarTipoDocumento.php?idTipoDocumento=<?php echo $rs['idtipodocumento']; ?>"><img src="../imagen/icon_edit.png" alt="Editar" border="0" /></a>&nbsp;
			<a href="delTipoDocumento.php?idTipoDocumento=<?php echo $rs['idtipodocumento']; ?>"><img src="../imagen/icon_del.png" alt="Eliminar" border="0" /></a>
			</div>
			</td>
      	 </tr>
