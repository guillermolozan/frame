...
<body>
<p class="titulo">Buscar <a href="#" style=" color:#FFFFFF">Vehiculos</a></p>
<?php 
					if(isset($_GET['msg'])){ 
					$display="";
						if($_GET['msg']=='1')
	...
	<div id="busqueda" >
<form method="post" style="font-size:10px; margin-top:10px; text-align:center; display:V" action="searchClientes" name="frmBuscarVehiculos" id="frmBuscarVehiculos" enctype="multipart/form-data">
		<label>Placa</label>
        <input type="text" id="IdPlaca" name="IdPlaca" style="text-transform:uppercase" size="12" class="sample1"/>
<br />
               <input type="submit" id="buscarVehiculo" name="buscarVehiculo" value="Buscar" class="boton">
