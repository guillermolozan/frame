...
<body>
  ...
  <div id="mainContent">
  <p class="titulo">UNIDADES DE MEDIDA</p>
	    <?php 
				if(isset($_GET['msg']))
				{ 
					$display="";
      		...
      		<div id="busqueda">
   			...
   			<input type="button" id="nuevoUniMed" name="nuevoUniMed" value="Nueva Unidad Medida" onClick="window.open('nuevoUniMed.php', '_self');" style=" float:right;border:#CCCCCC 1px solid; background:#666666; color:#ffffff" />
   			<br /><br />

   			<?php 
        	$consultaBase="SELECT * FROM unimed ";
			...
			<table width="98%" align="center" style="margin:0 10px;">
          			...
          			<td height="20" colspan="8">
						...
						<div class="paginacion" align="right">
          				<?php 
  							...
  							if($total_registros)
							{
								$principal="unimed_index";//pagina principal
								if(($pagina - 1) > 0)
								{
  		 	...
  		 	<tr>
            	...
            	<td width="20%" align="center" class="title"><div align="center">Abreviatura</div></td>
		...
		?>
     	  ...
     	  <tr>
           	...
           	<td class="tdcont" >&nbsp;&nbsp;<?php echo $rs['abreviatura']; ?></td>
            <td>
			<div align="center" class="tdcont">
			<a href="editarUniMed.php?idUniMed=<?php echo $rs['idunimed']; ?>"><img src="../imagen/icon_edit.png" alt="Editar" border="0" /></a>&nbsp;
			<a href="delUniMed.php?idUniMed=<?php echo $rs['idunimed']; ?>"><img src="../imagen/icon_del.png" alt="Eliminar" border="0" /></a>
			</div>
			</td>
      	 </tr>
